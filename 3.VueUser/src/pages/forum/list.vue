...
<div class="forum-preview" :style='{"width":"100%","padding":"30px calc((100% - 1200px)/2) 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <div :style='{"padding":"0px 0 0","margin":"0px auto","borderColor":"#ddd","textAlign":"center","background":"url(http://codegen.caihongy.cn/20240131/2a430ef16f4e4cd097649b7ed3473f46.png) no-repeat center bottom","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid","height":"48px"}'>
		<div :style='{"padding":"0 24px","borderColor":"#fb3f52","color":"rgba(22,159, 25,1)","textAlign":"left","background":"none","borderWidth":"0 0 0px","display":"inline-block","width":"auto","fontSize":"25px","lineHeight":"44px","borderStyle":"solid","fontWeight":"500"}'>宠物论坛</div>
	</div>
	...
	<div class="z-box" :style='{"border":"1px solid rgb(123, 123, 123)","width":"100%","padding":"30px 40px 40px","borderRadius":"10px"}'>
