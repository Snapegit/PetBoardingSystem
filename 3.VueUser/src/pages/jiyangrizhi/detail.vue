...
<div>
	<div :style='{"padding":"0 calc((100% - 1200px)/2)","margin":"0px auto","borderColor":"#e7e7e7","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20231012/4cb66b61fe1d4cb09b72cf0a4768c7be.jpg) repeat-x center center","borderWidth":"0px","width":"100%","borderStyle":"solid"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'|'" :style='{"width":"auto","padding":"10px 10px","fontSize":"14px","lineHeight":"1","background":"#fff","display":"inline-block"}'>
			...
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" to="/index/jiyangrizhi"><a>{{item.name}}</a></el-breadcrumb-item>
	...
	<div class="detail-preview" :style='{"border":"1px solid rgba(123,123,123,1)","padding":"10px 40px 20px","margin":"10px auto","alignItems":"flex-start","borderRadius":"10px","flexWrap":"wrap","display":"flex","width":"1200px","position":"relative","justifyContent":"space-between"}'>
		<div class="attr" :style='{"padding":"20px 0","margin":"0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","order":"2"}'>
			...
			<div class="info" :style='{"width":"100%","padding":"0 0px","margin":"0","background":"#fff","order":"2"}'>
				...
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#f3f3f3","background":"#fff","borderWidth":"0 0 0px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#333","textAlign":"right","width":"150px","fontSize":"14px","lineHeight":"24px","fontWeight":"500","height":"auto"}'>上传时间</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#555","flex":"1","height":"auto"}'>{{detail.shangchuanshijian}}</div>
				</div>
				<div class="btn" :style='{"padding":"10px 0px","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#333","borderRadius":"2px","background":"#009cf530","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('jiyangrizhi','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#333","borderRadius":"2px","background":"#f5340030","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('jiyangrizhi','删除')" @click="delClick">删除</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#333","borderRadius":"2px","background":"#f5340030","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('jiyangrizhi','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
				</div>
			</div>
		</div>
		...
		<div class="detail2" :style='{"border":"0px solid #ddd","padding":"0px","margin":"20px 0","borderRadius":"0px","background":"#fff","flex":"1","width":"100%","order":"10"}'>
			<div :style='{"border":"0px solid #f6f6f6","padding":"0","margin":"0 0 16px 0","borderColor":"#ddd","borderRadius":"0px","textAlign":"left","background":"none","borderWidth":"0 0 1px","borderStyle":"solid","height":"34px"}'>
				<div :style='{"padding":"0 0 8px","borderColor":"#007f18","color":"#007f18","borderWidth":"0 0 2px","display":"inline-block","fontSize":"18px","borderStyle":"solid"}'>宠物情况</div>
			</div>
			<div :style='{"color":"#666","padding":"0 24px","background":"#fff"}' v-html="detail.chongwuqingkuang"></div>
		</div>
  ...
  export default {
    ...
    methods: {
      ...
      nextClick(page) {
		...
		// 修改
		editClick(){
			this.$router.push(`/index/jiyangrizhiAdd?type=edit&&id=${this.detail.id}`);
		},
		// 删除
		async delClick(){
			await this.$confirm('是否删除此寄养日志？')
			  .then(_ => {
			    this.$http.post('jiyangrizhi/delete', [this.detail.id]).then(async res => {
					if (res.data.code == 0) {
						this.$message({
							type: 'success',
							message: '删除成功!',
