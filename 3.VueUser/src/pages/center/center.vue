    ...
    <el-tabs tab-position="left" :style='{"padding":"0 20px 40px","margin":"20px 0 0","flexWrap":"wrap","background":"#fff","flex":"1","display":"flex","width":"65%","float":"left","order":"1"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="130px">
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 40px","background":"#fff","display":"inline-block"}' v-if="userTableName=='yonghu'" label="账号" prop="zhanghao">
          ...
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 40px","background":"#fff","display":"inline-block"}' v-if="userTableName=='yonghu'" label="手机号" prop="shoujihao">
...
<script>
  ...
  export default {
    ...
    methods: {
      init() {
        if ('yonghu' == this.userTableName) {
          this.dynamicProp.xingbie = '女,男'.split(',');
        }
      },
	  setSession(){
