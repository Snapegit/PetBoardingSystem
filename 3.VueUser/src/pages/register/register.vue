<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20240202/d36e41b72d2d4c68a202194193ad67aa.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"border":"1px solid #fff","padding":"50px 120px 40px 40px","boxShadow":"0px 26px 26px -30px #999","margin":"100px auto","borderRadius":"12px","background":"rgba(255,255,255,.8)","width":"35vw","position":"relative","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"margin":"20px auto 10px","color":"rgba(0, 127, 24)","top":"-90px","textAlign":"center","left":"0","width":"100%","letterSpacing":"4px","lineHeight":"44px","fontSize":"30px","position":"absolute"}'>基于spring boot框架+vue的宠物寄养系统注册</p></div>
