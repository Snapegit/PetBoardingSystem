 ...
 */
public class ChongwuhuodongModel  implements Serializable {
	...
	public void setCanyufangshi(String canyufangshi) {
		this.canyufangshi = canyufangshi;
	}
	
	/**
	 * 获取：参与方式
	 */
	public String getCanyufangshi() {
		return canyufangshi;
	}
