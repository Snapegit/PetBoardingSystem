...
public class ChongwuzhongleiController {
    ...
    public R save(@RequestBody ChongwuzhongleiEntity chongwuzhonglei, HttpServletRequest request){
        if(chongwuzhongleiService.selectCount(new EntityWrapper<ChongwuzhongleiEntity>().eq("chongwuzhonglei", chongwuzhonglei.getChongwuzhonglei()))>0) {
            return R.error("宠物种类已存在");
        }
    ...
    public R update(@RequestBody ChongwuzhongleiEntity chongwuzhonglei, HttpServletRequest request){
        //ValidatorUtils.validateEntity(chongwuzhonglei);
        if(chongwuzhongleiService.selectCount(new EntityWrapper<ChongwuzhongleiEntity>().ne("id", chongwuzhonglei.getId()).eq("chongwuzhonglei", chongwuzhonglei.getChongwuzhonglei()))>0) {
            return R.error("宠物种类已存在");
        }
