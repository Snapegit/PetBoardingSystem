...
public class ChongwuxinxiController {
    ...
    public R save(@RequestBody ChongwuxinxiEntity chongwuxinxi, HttpServletRequest request){
        if(chongwuxinxiService.selectCount(new EntityWrapper<ChongwuxinxiEntity>().eq("chongwubianhao", chongwuxinxi.getChongwubianhao()))>0) {
            return R.error("宠物编号已存在");
        }
    ...
    public R update(@RequestBody ChongwuxinxiEntity chongwuxinxi, HttpServletRequest request){
        //ValidatorUtils.validateEntity(chongwuxinxi);
        if(chongwuxinxiService.selectCount(new EntityWrapper<ChongwuxinxiEntity>().ne("id", chongwuxinxi.getId()).eq("chongwubianhao", chongwuxinxi.getChongwubianhao()))>0) {
            return R.error("宠物编号已存在");
        }
